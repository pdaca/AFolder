...
(assert (fold_1_2 count data 0 i (* 5 sub_size) (* 6 sub_size)))

(assert (fold_1_2 count data 0 i (* 6 sub_size) (* 7 sub_size)))

(assert (fold_1_2 count data 0 i (* 7 sub_size) (* 8 sub_size)))

(assert (fold_1_2 count data 0 i (* 8 sub_size) (* 9 sub_size)))

(assert (fold_1_2 count data 0 i (* 9 sub_size) (* 10 sub_size)))

(assert (fold_1_2 count data 0 j (* 9 sub_size) (* 10 sub_size)))
